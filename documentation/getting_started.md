...
# Getting started
Please see [here](https://github.com/NEFSC/READ-SSB-Lee-project-templates) for general info about setting up stata and getting data out of Oracle with stata.
